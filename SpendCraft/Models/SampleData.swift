...
extension Transaction {
    static let sampleData: [Transaction] = [
        Transaction(id: 0, date: "2022-09-10", name: "Costco", amount: 170.24, institution: "Citi", account: "Credit Card", transactionCategories: [
        ...
        Transaction(id: 0, date: "2022-09-18", name: "Safeway", amount: 170.24, institution: "Citi", account: "Credit Card", transactionCategories: [
